function [R, T] = transfer_matrix_method_f(n1, n2, d1, d2, n0, ns, wavelengths, theta0, polarization, N)
    ...
    for idx = 1:num_wavelengths
        ...
        % Select the correct matrix based on polarization
...
%https://www.degruyter.com/document/doi/10.1515/nanoph-2020-0212/html: A simple transfer-matrix model for metasurface multilayer systems
%Annemarie Berkhout and A. Femius Koenderink
...
%Charalambos C. Katsidis and Dimitrios I. Siapkas" doi.org/10.1364/AO.41.003978